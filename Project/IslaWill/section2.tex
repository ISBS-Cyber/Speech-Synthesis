...
\begin{frame}{Solution: Use of Concepts like Transfer Learning}
    \begin{block}{Transfer Learning:}
        \begin{itemize}
            ...
            \item Hidden Markov Model (HMM) was standard for most early work in speech synthesis and voice banking \cite{yamagishi2009analysis}.
            \item Neural TTS is newer, though it requires more data than HMM, it also possesses an increased naturalness \cite{watts2016hmms}.
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{Solution: Development of Naturalness in Newer Models}
    \begin{block}{Naturalness Development:}
        \begin{itemize}
            ...
            \item \textbf{Tacotron 2} - has already been applied and used by those with MND and Dysarthria \cite{zhao2021personalizing}.
            \item \textbf{Neural HMM} - proposed altered model of Tacotron 2, requires less data and has great potential for those with MND \cite{mehta2022neural}.
        \end{itemize}
    \end{block}
\end{frame}
