    ...
    \begin{block}{Robustness:}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Repeated / skipped words \cite{shen2017tacotron2}
            \end{itemize}
            \item Out of distribution inputs
            \begin{itemize}
                \item Rare names and abbreviations
                \item Unseen speakers or accents \cite{lui2023survey}
            \end{itemize}
            \item Low-resource languages reduce model stability \cite{luo2020lrspeech}
        \end{itemize}
    \end{block}
    ...
    \begin{block}{Reliability}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item VITS: MOS $\approx 4.4$ \cite{kim2021conditional}
            \end{itemize}
        \end{itemize}
    \end{block}
\end{frame}
...
\begin{frame}{Results: Evaluation of Speech Synthesis}
    ...
    \begin{column}{0.5\textwidth}
        \begin{block}{Bad:}
            \begin{itemize}
                \item Hard to use \cite{valencia2023the}
                \begin{itemize}
                    \item Complexity
                    \item Effort 
                \end{itemize}
                ...
                \item Emotionless \cite{michael2025representation}
                ...
                \item Professional support \cite{cave2020voice, jackson2025stage}
                \begin{itemize}
    ...
    \begin{column}{0.5\textwidth}
        \begin{block}{Good:}
            \begin{itemize}
                ...
                \item Predictive text \cite{valencia2023the}
                \begin{itemize}
                ...
                \item Maintain connections \cite{cave2020voice, lavoisier2017dysarthria}
    ...
    \begin{columns}[t]
        \begin{column}{0.5\textwidth}
            \begin{block}{How the Technology May Look:}
                \begin{itemize}
                    \item Highly natural near-human expressive voices \cite{kim2021conditional}
                    \item Real-time adaptive speech for interactive systems \cite{lui2023survey}
                    \item Multi-accent, multi-language support \cite{zhang2024multilingual, luo2020lrspeech}
        ...
        \begin{column}{0.5\textwidth}
            \begin{block}{Potential Applications:}
                \begin{itemize}
                    \item More accessible for speech-impaired users \cite{luo2020lrspeech}
    ...
    \begin{column}{0.5\textwidth}
        \begin{block}{Limited Studies:}
            \begin{itemize}
                ...
                \item Limited research into how voice characteristics affect speech synthesis. \cite{michael2025representation}
                ...
                \item Limited research exploring views on speech synthesis throughout disease progression. \cite{barry2025banking}
